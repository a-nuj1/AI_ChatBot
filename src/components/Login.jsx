...
import { useAuth } from '../components/AuthContext'; // Import useAuth from context
      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center">
        <div className="w-100 text-gray-600 space-y-10 p-16 shadow-xl border rounded-xl">
          <div className="text-center">
            <div className="mt-2">
              <h3 className="text-gray-700 text-xl font-semibold sm:text-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <label className="text-sm text-gray-900 font-bold">Password</label>
              <input
                type="password"
                required
                value={password}
